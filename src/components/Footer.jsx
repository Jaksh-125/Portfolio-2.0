...
import Me from "./assests/imgs/jaksh-round.jpeg";
    ...
    return (
        <footer className='pt-10 pb-5 border-t-[#4f4f4f] border-t-2 md:px-6 lg:px-16 xl:px-26 2xl:px-32 '>
            ...
            <div className='socials my-10'>
                ...
                <div className='lg:flex lg:justify-between lg:items-start'>
                    <div className='flex gap-3 items-center lg:items-start'>
                        ...
                        >
                            <a
                                href='https://linkedin.com/in/jaksh-patel-512b77234/'
                                target='_target'
                                rel='noreferrer'
                            >
                                <FaLinkedinIn
                        ...
                        >
                            <a
                                href='https://www.instagram.com/jaksh_2510/'
                                target='_target'
                                rel='noreferrer'
                            >
                                <FaInstagram
                        ...
                        >
                            <a
                                href='https://github.com/Jaksh-125'
                                target='_target'
                                rel='noreferrer'
                            >
                                <FaGithub
            ...
            <p className='text-right uppercase text-black cursor-pointer'>
                &copy; Jaksh {new Date().getFullYear()}
            </p>
        </footer>
    );
};
